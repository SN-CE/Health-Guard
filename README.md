...
The dev branch has implemented this late-stage fusion, ensemble multi-modality. The multi-modal aspect is late fusion via simple averaging, not learned fusion, because paired patient data was unavailable. This is a screening tool.
